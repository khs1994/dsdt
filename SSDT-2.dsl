 ...
 *
 * Disassembly of SSDT-2.aml, Wed Sep 13 23:44:40 2017
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x00003308 (13064)
 *     Revision         0x01
 *     Checksum         0x4D
 *     OEM ID           "ACRSYS"
 *     OEM Table ID     "RP01"
 ...
 */
DefinitionBlock ("", "SSDT", 1, "ACRSYS", "RP01", 0x00001000)
{
    ...
    External (_SB_.PCI0.GFX0.CAL2, FieldUnitObj)    // (from opcode)
    External (_SB_.PCI0.GFX0.CAL3, FieldUnitObj)    // (from opcode)
    External (_SB_.PCI0.GFX0.CAL4, FieldUnitObj)    // (from opcode)
    External (_SB_.PCI0.GFX0.CAL5, FieldUnitObj)    // (from opcode)
    External (_SB_.PCI0.GFX0.CAL6, FieldUnitObj)    // (from opcode)
    External (_SB_.PCI0.GFX0.CAL7, FieldUnitObj)    // (from opcode)
    External (_SB_.PCI0.GFX0.CAL8, FieldUnitObj)    // (from opcode)
    External (_SB_.PCI0.GFX0.CPDL, FieldUnitObj)    // (from opcode)
    ...
    External (_SB_.PCI0.GFX0.CPL5, FieldUnitObj)    // (from opcode)
    External (_SB_.PCI0.GFX0.CPL6, FieldUnitObj)    // (from opcode)
    External (_SB_.PCI0.GFX0.CPL7, FieldUnitObj)    // (from opcode)
    External (_SB_.PCI0.GFX0.CPL8, FieldUnitObj)    // (from opcode)
    External (_SB_.PCI0.LPCB.EC0_.CTMP, FieldUnitObj)    // (from opcode)
    ...
    External (_SB_.VSSD, FieldUnitObj)    // (from opcode)
    ...
    {
        OperationRegion (VBOR, SystemMemory, 0x77F45018, 0x00040004)
    ...
    Scope (\_SB.PCI0.RP01.PXSX)
    {
        OperationRegion (SGOP, SystemMemory, 0x7662EF98, 0x4D)
    ...
    Scope (\_SB.PCI0.RP01.PXSX)
    {
        OperationRegion (NOPR, SystemMemory, 0x77FAB018, 0x2010)
