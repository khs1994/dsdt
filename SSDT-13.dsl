 ...
 *
 * Disassembly of SSDT-13.aml, Wed Sep 13 16:52:23 2017
 *
...
DefinitionBlock ("", "SSDT", 1, "ACRSYS", "ACRPRDCT", 0x00001000)
{
    ...
    Scope (\_SB.PCI0.RP01.PXSX)
    {
        OperationRegion (SGOP, SystemMemory, 0x7662EF98, 0x0000004D)
    ...
    Scope (\_SB.PCI0.RP01.PXSX)
    {
        OperationRegion (NOPR, SystemMemory, 0x77FAB018, 0x00002010)
